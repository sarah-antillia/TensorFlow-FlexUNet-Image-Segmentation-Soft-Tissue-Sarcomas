...
if __name__ == "__main__":
  try:
    images_dir = "./Augmented-Soft-Tissue-Sarcomas-CTPET/images/"
    masks_dir  = "./Augmented-Soft-Tissue-Sarcomas-CTPET/masks/"
    output_dir = "./Augmented-Soft-Tissue-Sarcomas-CTPET-ImageMask-Dataset/"
